...
class Optimizer(_mod_builtins.object):
    ...
    __class__ = Optimizer
    __dict__ = {}
    def __init__(self, ops, lr, L2, beta1, beta2, eps, decay, decay_steps, b1_decay, b2_decay, max_grad_norm, gradient_noise, nesterov, L2_is_weight_decay):
        'Do various flavours of stochastic gradient descent, with first and\n    second order momentum.\n    \n    Examples\n    \n    * beta1=0., beta2=0.: "vanilla" SGD\n    * beta1=0.9, beta2=0.: "Classic momentum"\n    * beta1=0.0, beta2=0.2: RMS prop\n    * b1=0.999, b2=0.9: Adam\n    '
        pass
...
__builtins__ = {}
__doc__ = None
__file__ = '/home/gordon/p3env/lib/python3.7/site-packages/thinc/neural/optimizers.cpython-37m-x86_64-linux-gnu.so'
