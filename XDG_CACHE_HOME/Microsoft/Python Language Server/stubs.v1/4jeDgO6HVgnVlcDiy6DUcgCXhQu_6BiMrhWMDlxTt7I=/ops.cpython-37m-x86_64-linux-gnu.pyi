...
class CupyOps(Ops):
    ...
    device = 'gpu'
    def gemm(self, x, y, out, trans1, trans2):
        pass
...
class NumpyOps(Ops):
    ...
    def backprop_relu(self, dY, Y, inplace):
        pass
    ...
    def gemm(self, x, y, trans1, trans2, out):
        pass
    ...
    def inplace_add(self, x, y, scale):
        pass
...
class Ops(_mod_builtins.object):
    ...
    def backprop_lstm(self, d_cells, d_prev, d_gate_pieces, d_output, gate_pieces, cells, prev):
        pass
    ...
    def batch_dot(self, x, y, transpose):
        pass
...
__builtins__ = {}
__doc__ = None
__file__ = '/home/gordon/p3env/lib/python3.7/site-packages/thinc/neural/ops.cpython-37m-x86_64-linux-gnu.so'
