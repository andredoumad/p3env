...
AFMT_U16_LE = 128
AFMT_U8 = 8
class OSSAudioError(_mod_builtins.Exception):
    __class__ = OSSAudioError
    __dict__ = {}
...
__doc__ = None
__file__ = '/home/gordon/p3env/lib/python3.7/lib-dynload/ossaudiodev.cpython-37m-x86_64-linux-gnu.so'
__name__ = 'ossaudiodev'
__package__ = ''
control_labels = _mod_builtins.list()
control_names = _mod_builtins.list()
error = OSSAudioError()
def open():
    pass
